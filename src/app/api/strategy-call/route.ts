...
---
This booking was submitted via the strategy call modal on mapthegap.ai.
    `.trim()
        ...
        html: `
          <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f7fafc;">
            <div style="background: white; border-radius: 12px; padding: 32px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              ...
              <p style="color: #718096; margin-bottom: 32px; font-size: 14px;">Someone just requested a strategy call on mapthegap.ai</p>
