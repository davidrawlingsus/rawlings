      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <div className="flex items-center gap-4 ml-8">
            <Link href="https://vizualized.marketably.ai" className="border-2 border-white text-white px-6 py-2 rounded-lg font-semibold text-sm uppercase hover:bg-white hover:text-[#1A2B3C] transition-colors">
              LOG IN
            </Link>
            <button 
        ...
        <div className="lg:hidden mt-4 pb-4">
          <div className="flex flex-col space-y-4">
            ...
            <div className="pt-4 flex flex-col gap-3">
              <Link href="https://vizualized.marketably.ai" onClick={closeMobileMenu} className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold text-sm uppercase hover:bg-white hover:text-[#1A2B3C] transition-colors block text-center">
                LOG IN
              </Link>
              <button 
                onClick={openStrategyCallModal}
