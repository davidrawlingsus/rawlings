    ...
    <main className="min-h-screen bg-black">
        ...
        <section className="mtg-hero mtg-wrap">
          ...
          <div className="mtg-fade-up" style={{ transitionDelay: '0.2s' }}>
            <p className="mtg-subtitle">
              Enter your URL. My AI brain will instantly read your reviews and show you the gap
      ...
      <section className="border-y border-neutral-800 bg-neutral-900/50">
        <div className="max-w-7xl mx-auto px-6 md:px-8 py-4">
          <p className="text-center text-sm text-neutral-500 mb-2">Based on the conversion strategies deployed <a href="#about" className="text-neutral-300 underline hover:text-white transition-colors">by David</a> at...</p>
        </div>
